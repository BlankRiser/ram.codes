				...
				return (
					<li key={index}>
						<Link
							href={value}
							className={cn(
								"relative z-10 block rounded-full px-4 py-1 text-neutral-400 hover:bg-neutral-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-devhaven-500 active:bg-neutral-800/50",
								pathname.startsWith(value) &&
									"text-neutral-200 outline outline-1 outline-neutral-900",
